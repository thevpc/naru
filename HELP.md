```
  ...
  ▌ /tools  [options...]
  ▌     manage AI tools
  ▌   /tools  add-tagged <tag-name>... [<tag-name>...]
  ▌            add tools with the given tags
  ▌   /tools  all 
  ▌            list all tools
  ▌   /tools  exclude <tool-name>... [<tool-name>...]
  ▌            add tool to exclusion set
  ▌   /tools  excluded 
  ▌            list excluded tools
  ▌   /tools 
  ▌   /tools  list 
  ▌            list selected tools
  ▌   /tools  remove-tagged <tag-name>... [<tag-name>...]
  ▌            remove tools with the given tags
  ...
  ▌   /tools  tags 
  ▌            list available tags
  ▌   /tools  unexclude <tool-name>... [<tool-name>...]
  ▌            remove tool from exclusion set
  ▌   /tools  unselected 
  ▌            list unselected (non included) tools
  ▌   /tools  [ help | --help ]
  ▌            show tools help
  ▌     -----------------------------------------
  ▌   fs Directives:
