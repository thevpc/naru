...
public class NaruStandardModeImpl implements NaruMode {
    public static final NaruMode ASK = new NaruStandardModeImpl(
    ...
    public static final NaruMode PLANNING = new NaruStandardModeImpl(
    ...
    public static final NaruMode IMPLEMENT = new NaruStandardModeImpl(
    ...
    public static final NaruMode REVIEW = new NaruStandardModeImpl(
    ...
    public static final NaruMode AUDIT = new NaruStandardModeImpl(
    ...
    public static final NaruMode DEBUG = new NaruStandardModeImpl(
    ...
    public NaruStandardModeImpl(NaruStandardMode standardMode, String[] alias, String prompt) {
    ...
    public boolean equals(Object o) {
        ...
        NaruStandardModeImpl that = (NaruStandardModeImpl) o;
