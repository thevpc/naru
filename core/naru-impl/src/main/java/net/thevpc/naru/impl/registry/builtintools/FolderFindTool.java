...
public class FolderFindTool implements NaruTool {
    ...
    public NaruToolDefinition getDefinition(NaruSession session) {
        return new NaruToolDefinitionFunction(
                ...
                NaruToolParameter.integer("max_matches", "Max matches per file", false, DEFAULT_MAX_MATCHES).build(),
                NaruToolParameter.integer("max_files", "Max files to scan", false, DEFAULT_MAX_FILES).build(),
