...
public class HistoryDirective extends AbstractDirective {
    ...
    private void logRow(int rowIndex, int max, NaruMessage a, NaruSessionContext sessionContext) {
    ...
    public void executeHelp(NaruDirectiveCallContext context, NCmdLine cmdLine) {
        ...
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s ", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s list", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s list <n1>-<p1>,<n2>-<p2>", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("           show history for intervals"));

        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s drop <n1>-<p1>,<n2>-<p2>", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("           drop intervals"));

        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s clear", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("           clear history"));

        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s trim", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s trim <n>", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("           trim history to <n> messages (default 1024)"));

        sessionContext.log(NaruLogMode.AGENT_RESPONSE, NMsg.ofC("%s%s help", NMsg.ofStyledSeparator("/"), NMsg.ofStyledPrimary1("history")));
